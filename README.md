...
- [x] **Sprint 2** — Matching engine + order book + tests
- [x] **Sprint 3** — REST API + database + migrations
- [x] **Sprint 4** — Terraform + LocalStack resources
- [x] **Sprint 5** — Asynchronous settlement worker
